...
// Order matches PROGRAMS in lib/site.ts — data and AI tracks first.
    ...
    <section className="programs" id="programs">
      <div className="container">
        ...
        <div className="programs-grid">
          {CARDS.map(({ slug, title, desc, skills, Icon }) => (
            <article className="program-card" key={slug}>
              <Link
                href={`/${slug}`}
              ...
              <div className="program-footer">
                ...
                <Link href={`/${slug}`} className="btn btn-outline btn-sm">
                  Learn More
                </Link>
              </div>
            </article>
